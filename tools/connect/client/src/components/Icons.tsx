// Lightweight outline icon set (Feather/Lucide-style: 24x24, stroke=currentColor,
// strokeWidth=2, round caps/joins). No external icon library dependency.
...
export function IconVideoOff(props: SVGProps<SVGSVGElement>) {
  return (
    <Base {...props}>
